...
function consumerMarkDirty(node) {
  ...
  (_a5 = node.consumerMarkedDirty) == null ? void 0 : _a5.call(node, node);
}
...
function consumerIsLive(node) {
  var _a5;
  return node.consumerIsAlwaysLive || (((_a5 = node == null ? void 0 : node.liveConsumerNode) == null ? void 0 : _a5.length) ?? 0) > 0;
}
...
var Dispatcher = class {
  ...
  dispatch(eventInfo) {
    ...
    (_a5 = this.actionResolver) == null ? void 0 : _a5.resolveEventType(eventInfo);
...
function prepareEventForDispatch(eventInfoWrapper) {
  var _a5;
  const event = eventInfoWrapper.getEvent();
  const currentTarget = (_a5 = eventInfoWrapper.getAction()) == null ? void 0 : _a5.element;
  if (currentTarget) {
...
function getQueuedEventInfos(earlyJsactionData) {
  return (earlyJsactionData == null ? void 0 : earlyJsactionData.q) ?? [];
}
...
var _EventContract = class _EventContract {
  ...
  handleEventInfo(eventInfo) {
    ...
    if (!this.dispatcher) {
      ...
      (_a5 = this.queuedEventInfos) == null ? void 0 : _a5.push(eventInfo);
      return;
    }
  ...
  cleanUp() {
    var _a5;
    (_a5 = this.containerManager) == null ? void 0 : _a5.cleanUp();
  ...
  ecrd(dispatcher, restriction) {
    ...
    if ((_a5 = this.queuedEventInfos) == null ? void 0 : _a5.length) {
...
function getAppScopedQueuedEventInfos(appId, dataContainer = window) {
  var _a5;
  return getQueuedEventInfos((_a5 = dataContainer._ejsas) == null ? void 0 : _a5[appId]);
}
...
function createInputSignal(initialValue, options) {
  ...
  function inputValueFn() {
    ...
    if (node.value === REQUIRED_UNSET_VALUE) {
      let message = null;
      if (ngDevMode) {
        const name = (options == null ? void 0 : options.debugName) ?? (options == null ? void 0 : options.alias);
...
function requiresRefreshOrTraversal(lView) {
  var _a5;
  return !!(lView[FLAGS] & (1024 | 8192) || ((_a5 = lView[REACTIVE_TEMPLATE_CONSUMER]) == null ? void 0 : _a5.dirty));
}
function updateAncestorTraversalFlagsOnAttach(lView) {
  var _a5;
  (_a5 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a5.notify(8);
  if (lView[FLAGS] & 64) {
    lView[FLAGS] |= 1024;
  }
...
function markAncestorsForTraversal(lView) {
  var _a5;
  (_a5 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a5.notify(0);
...
var EventEmitter_ = class extends Subject {
  ...
  subscribe(observerOrNext, error, complete) {
    ...
    if (observerOrNext && typeof observerOrNext === "object") {
      ...
      nextFn = (_a5 = observer.next) == null ? void 0 : _a5.bind(observer);
  ...
  wrapInTimeout(fn) {
    return (value) => {
      var _a5;
      const taskId = (_a5 = this.pendingTasks) == null ? void 0 : _a5.add();
      setTimeout(() => {
        var _a6;
        try {
          fn(value);
          ...
          if (taskId !== void 0) {
            (_a6 = this.pendingTasks) == null ? void 0 : _a6.remove(taskId);
          }
        }
      });
    };
...
function hasApplyArgsData(applyArgs, key) {
  ...
  return ((_b = (_a5 = applyArgs[0]) == null ? void 0 : _a5.data) == null ? void 0 : _b[key]) === true;
}
    ...
    try {
      for (const listenerFn of this.listeners) {
        try {
          ...
          (_a5 = this.errorHandler) == null ? void 0 : _a5.handleError(err);
        }
      }
    } finally {
...
var QueryList = class {
  ...
  setDirty() {
    var _a5;
    this.dirty = true;
    (_a5 = this._onDirty) == null ? void 0 : _a5.call(this);
  }
  /** internal */
  destroy() {
...
var CSP_NONCE = new InjectionToken(ngDevMode ? "CSP nonce" : "", {
  ...
  factory: () => {
    var _a5, _b;
    return ((_b = (_a5 = getDocument().body) == null ? void 0 : _a5.querySelector("[ngCspNonce]")) == null ? void 0 : _b.getAttribute("ngCspNonce")) || null;
  }
});
...
function performanceMarkFeature(feature) {
  ...
  (_a5 = performance == null ? void 0 : performance.mark) == null ? void 0 : _a5.call(performance, "mark_feature_usage", {
    detail: {
      feature
    }
  });
...
var _AfterRenderManager = class _AfterRenderManager {
  ...
  execute() {
    var _a5;
    (_a5 = this.impl) == null ? void 0 : _a5.execute();
  }
};
/** @nocollapse */
__publicField(
...
var _AfterRenderImpl = class _AfterRenderImpl {
  ...
  register(sequence) {
    ...
    if (view !== void 0) {
      (view[AFTER_RENDER_SEQUENCES_TO_ADD] ?? (view[AFTER_RENDER_SEQUENCES_TO_ADD] = [])).push(sequence);
...
var AfterRenderSequence = class {
  ...
  afterRun() {
    ...
    (_a5 = this.snapshot) == null ? void 0 : _a5.dispose();
    this.snapshot = null;
  }
  destroy() {
    var _a5, _b;
    this.impl.unregister(this);
    (_a5 = this.unregisterOnDestroy) == null ? void 0 : _a5.call(this);
    const scheduled = (_b = this.view) == null ? void 0 : _b[AFTER_RENDER_SEQUENCES_TO_ADD];
    if (scheduled) {
...
function afterRenderImpl(callbackOrSpec, injector, options, once) {
  ...
  const hooks = (options == null ? void 0 : options.phase) ?? AfterRenderPhase.MixedReadWrite;
...
function getMinimumDurationForState(tDetails, currentState) {
  ...
  if (currentState === DeferBlockState.Placeholder) {
    return ((_a5 = tDetails.placeholderBlockConfig) == null ? void 0 : _a5[MINIMUM_SLOT]) ?? null;
...
function getLoadingBlockAfter(tDetails) {
  var _a5;
  return ((_a5 = tDetails.loadingBlockConfig) == null ? void 0 : _a5[LOADING_AFTER_SLOT]) ?? null;
}
...
function trackTriggerForDebugging(tView, tNode, textRepresentation) {
  ...
  (_a5 = tDetails.debug).triggers ?? (_a5.triggers = /* @__PURE__ */ new Set());
...
function setJSActionAttributes(nativeElement, eventTypes, parentDeferBlockId = null) {
  ...
  const parts = eventTypes.reduce((prev, curr) => {
    return ((existingAttr == null ? void 0 : existingAttr.indexOf(curr)) ?? -1) === -1 ? prev + curr + ":;" : prev;
  }, "");
...
function invokeListeners(event, currentTarget) {
  var _a5;
  const handlerFns = (_a5 = currentTarget == null ? void 0 : currentTarget.__jsaction_fns) == null ? void 0 : _a5.get(event.type);
...
var _DehydratedBlockRegistry = class _DehydratedBlockRegistry {
  ...
  cleanup(hydratedBlocks) {
    ...
    if (this.size === 0) {
      (_a5 = this.contract.instance) == null ? void 0 : _a5.cleanUp();
    }
  }
  get size() {
...
function getTextNodeContent(node) {
  var _a5;
  return (_a5 = node.textContent) == null ? void 0 : _a5.replace(/\s/gm, "");
}
...
function isRNodeClaimedForHydration(node) {
  var _a5;
  return ((_a5 = readHydrationInfo(node)) == null ? void 0 : _a5.status) === HydrationStatus.Hydrated;
}
...
function getSegmentHead(hydrationInfo, index) {
  var _a5;
  return ((_a5 = hydrationInfo.segmentHeads) == null ? void 0 : _a5[index]) ?? null;
}
...
function getNgContainerSize(hydrationInfo, index) {
  ...
  let size = ((_a5 = data[ELEMENT_CONTAINERS]) == null ? void 0 : _a5[index]) ?? null;
...
function isSerializedElementContainer(hydrationInfo, index) {
  var _a5;
  return ((_a5 = hydrationInfo.data[ELEMENT_CONTAINERS]) == null ? void 0 : _a5[index]) !== void 0;
}
function getSerializedContainerViews(hydrationInfo, index) {
  var _a5;
  return ((_a5 = hydrationInfo.data[CONTAINERS]) == null ? void 0 : _a5[index]) ?? null;
}
...
function isDisconnectedNode$1(hydrationInfo, index) {
  ...
  return !!((_a5 = initDisconnectedNodes(hydrationInfo)) == null ? void 0 : _a5.has(index));
}
function processTextNodeBeforeSerialization(context, node) {
  ...
  } else if (((_a5 = el.nextSibling) == null ? void 0 : _a5.nodeType) === Node.TEXT_NODE) {
    corruptedTextNodes.set(
      el,
      "ngtns"
...
function getHydrateTimerTrigger(blockData) {
  var _a5;
  const trigger = (_a5 = blockData[DEFER_HYDRATE_TRIGGERS]) == null ? void 0 : _a5.find((t) => isTimerTrigger(t));
  return (trigger == null ? void 0 : trigger.delay) ?? null;
}
function hasHydrateTrigger(blockData, trigger) {
  var _a5;
  return ((_a5 = blockData[DEFER_HYDRATE_TRIGGERS]) == null ? void 0 : _a5.includes(trigger)) ?? false;
}
...
function isSsrContentsIntegrity(node) {
  var _a5;
  return !!node && node.nodeType === Node.COMMENT_NODE && ((_a5 = node.textContent) == null ? void 0 : _a5.trim()) === SSR_CONTENT_INTEGRITY_MARKER;
}
...
function getTemplateLocationDetails(lView) {
  ...
  const componentClassName = (_a5 = hostComponentDef == null ? void 0 : hostComponentDef.type) == null ? void 0 : _a5.name;
...
function trustedHTMLFromString(html) {
  var _a5;
  return ((_a5 = getPolicy$1()) == null ? void 0 : _a5.createHTML(html)) || html;
}
function trustedScriptURLFromString(url) {
  var _a5;
  return ((_a5 = getPolicy$1()) == null ? void 0 : _a5.createScriptURL(url)) || url;
}
var policy;
function getPolicy() {
  if (policy === void 0) {
...
function trustedHTMLFromStringBypass(html) {
  var _a5;
  return ((_a5 = getPolicy()) == null ? void 0 : _a5.createHTML(html)) || html;
}
function trustedScriptFromStringBypass(script) {
  var _a5;
  return ((_a5 = getPolicy()) == null ? void 0 : _a5.createScript(script)) || script;
}
function trustedScriptURLFromStringBypass(url) {
  var _a5;
  return ((_a5 = getPolicy()) == null ? void 0 : _a5.createScriptURL(url)) || url;
}
...
var DOMParserHelper = class {
  ...
  getInertBodyElement(html) {
    ...
    try {
      ...
      (_a5 = body.firstChild) == null ? void 0 : _a5.remove();
      return body;
    } catch {
      return null;
    }
...
function ɵɵvalidateAttribute(value, tagName, attributeName2) {
  ...
  if (!((_a5 = SECURITY_SENSITIVE_ELEMENTS[lowerCaseTagName]) == null ? void 0 : _a5.has(lowerCaseAttrName))) {
    return value;
  }
...
function setNgReflectProperties(lView, tView, tNode, publicName, value) {
  ...
  const inputConfig = (_a5 = tNode.inputs) == null ? void 0 : _a5[publicName];
  const hostInputConfig = (_b = tNode.hostDirectiveInputs) == null ? void 0 : _b[publicName];
  if (hostInputConfig) {
...
function storePropertyBindingMetadata(tData, tNode, propertyName, bindingIndex, ...interpolationParts) {
  ...
  if (tData[bindingIndex] === null) {
    if (!((_a5 = tNode.inputs) == null ? void 0 : _a5[propertyName]) && !((_b = tNode.hostDirectiveInputs) == null ? void 0 : _b[propertyName])) {
...
function setAllInputsForProperty(tNode, tView, lView, publicName, value) {
  var _a5, _b;
  const inputs = (_a5 = tNode.inputs) == null ? void 0 : _a5[publicName];
  const hostDirectiveInputs = (_b = tNode.hostDirectiveInputs) == null ? void 0 : _b[publicName];
  let hasMatch = false;
...
function renderView(tView, lView, context) {
  ...
  try {
    ...
    (_a5 = lView[QUERIES]) == null ? void 0 : _a5.finishViewCreation(tView);
...
function detachViewFromDOM(tView, lView) {
  var _a5;
  (_a5 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a5.notify(9);
...
function detectChangesInternal(lView, notifyErrorHandler = true, mode = 0) {
  ...
  if (!checkNoChangesMode) {
    (_a5 = rendererFactory.begin) == null ? void 0 : _a5.call(rendererFactory);
  }
  try {
...
function markViewDirty(lView, source) {
  ...
  (_a5 = lView[ENVIRONMENT].changeDetectionScheduler) == null ? void 0 : _a5.notify(source);
  while (lView) {
...
var R3TemplateRef = class TemplateRef2 extends ViewEngineTemplateRef {
  ...
  get ssrId() {
    var _a5;
    return ((_a5 = this._declarationTContainer.tView) == null ? void 0 : _a5.ssrId) || null;
  }
...
function isFirstElementInNgContainer(tNode) {
  var _a5;
  return !tNode.prev && ((_a5 = tNode.parent) == null ? void 0 : _a5.type) === 8;
}
...
function gatherDeferBlocksCommentNodes(doc, node) {
  ...
  while (currentNode = commentNodesIterator.nextNode()) {
    ...
    const nghIdx = (content == null ? void 0 : content.indexOf(nghPattern)) ?? -1;
    if (nghIdx > -1) {
...
function acceptNode(node) {
  var _a5;
  return ((_a5 = node.textContent) == null ? void 0 : _a5.trimStart().startsWith("ngh=")) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_REJECT;
}
...
function prepareI18nBlockForHydrationImpl(lView, index, parentTNode, subTemplateIndex) {
  ...
  const caseQueue = ((_a5 = hydrationInfo.data[I18N_DATA]) == null ? void 0 : _a5[index - HEADER_OFFSET]) ?? [];
...
function collectI18nNodesFromDom(context, state, nodeOrNodes) {
  ...
  if (Array.isArray(nodeOrNodes)) {
    ...
    switch (nodeOrNodes.kind) {
      ...
      case 1: {
        collectI18nNodesFromDom(context, forkHydrationState(state, ((_a5 = state.currentNode) == null ? void 0 : _a5.firstChild) ?? null), nodeOrNodes.children);
        const currentNode = appendI18nNodeToCollection(context, state, nodeOrNodes);
        setCurrentNode(state, (currentNode == null ? void 0 : currentNode.nextSibling) ?? null);
        break;
      }
...
function claimDehydratedIcuCaseImpl(lView, icuIndex, caseIndex) {
  var _a5;
  const dehydratedIcuDataMap = (_a5 = lView[HYDRATION]) == null ? void 0 : _a5.dehydratedIcuData;
...
function resolveHostDirectives(matches) {
  ...
  for (const def of matches) {
    if (def.findHostDirectiveDefs !== null) {
      allDirectiveDefs ?? (allDirectiveDefs = []);
...
function populateDehydratedViewsInLContainerImpl(lContainer, tNode, hostLView) {
  ...
  const serializedViews = (_a5 = hydrationInfo.data[CONTAINERS]) == null ? void 0 : _a5[noOffsetIndex];
...
function resolveComponentResources(resourceResolver) {
  ...
  componentResourceResolutionQueue.forEach((component, type) => {
    ...
    if (component.styleUrl && ((_a5 = component.styleUrls) == null ? void 0 : _a5.length)) {
...
function initFeatures(definition) {
  var _a5;
  (_a5 = definition.features) == null ? void 0 : _a5.forEach((fn) => fn(definition));
}
...
function locateOrCreateContainerAnchorImpl(tView, lView, tNode, index) {
  ...
  const ssrId = ((_a5 = hydrationInfo.data[TEMPLATES]) == null ? void 0 : _a5[index]) ?? null;
...
function findMatchingDehydratedViewForDeferBlock(lContainer, lDetails) {
  var _a5;
  const dehydratedViewIx = ((_a5 = lContainer[DEHYDRATED_VIEWS]) == null ? void 0 : _a5.findIndex((view) => view.data[DEFER_BLOCK_STATE$1] === lDetails[DEFER_BLOCK_STATE])) ?? -1;
...
function applyDeferBlockState(newState, lDetails, lContainer, tNode, hostLView) {
  ...
  if (stateTmplIndex !== null) {
    ...
    if (dehydratedViewIx > -1) {
      (_a5 = lContainer[DEHYDRATED_VIEWS]) == null ? void 0 : _a5.splice(dehydratedViewIx, 1);
    }
...
function getDeferBlocks(node) {
  var _a5;
  const results = [];
  const lView = (_a5 = getLContext(node)) == null ? void 0 : _a5.lView;
  if (lView) {
  ...
  for (const details of blocks) {
    ...
    const data = {
      ...
      loadingBlock: {
        ...
        minimumTime: ((_a5 = tDetails.loadingBlockConfig) == null ? void 0 : _a5[MINIMUM_SLOT]) ?? null,
        afterTime: ((_b = tDetails.loadingBlockConfig) == null ? void 0 : _b[LOADING_AFTER_SLOT]) ?? null
      },
      placeholderBlock: {
...
function getDependenciesForTokenInInjector(token, injector) {
  ...
  if (!(injector instanceof NodeInjector)) {
    return ((_b = (_a5 = resolverToTokenToDependencies.get(injector)) == null ? void 0 : _a5.get) == null ? void 0 : _b.call(_a5, token)) ?? [];
  }
  const lView = getNodeInjectorLView(injector);
  ...
  return dependencies.filter((dependency) => {
    var _a6;
    const dependencyNode = (_a6 = dependency.injectedIn) == null ? void 0 : _a6.tNode;
    ...
    if (!visitedContainers.has(container)) {
      for (const prov of providerToPath.keys()) {
        ...
        deepForEach(containerDef.imports, (moduleImport) => {
          ...
          if (isNextStepInPath) {
            (_a5 = providerToPath.get(prov)) == null ? void 0 : _a5.unshift(container);
          }
        });
      }
    }
...
function getInjectorParent(injector) {
  ...
  if (hasParentInjector(parentLocation)) {
    ...
    const injectorParent = (_a5 = chainedInjector.injector) == null ? void 0 : _a5.parent;
...
function getNodesAndEdgesFromSignalMap(signalMap) {
  ...
  for (const [consumer, producers] of signalMap.entries()) {
    ...
    if (isComputedNode(consumer) || isSignalNode(consumer)) {
      ...
      debugSignalGraphNodes.push({
        label: consumer.debugName ?? ((_d = (_c = (_b = (_a5 = consumer.lView) == null ? void 0 : _a5[HOST]) == null ? void 0 : _b.tagName) == null ? void 0 : _c.toLowerCase) == null ? void 0 : _d.call(_c)),
        kind: consumer.kind
      });
...
var _Testability = class _Testability {
  ...
  _watchAngularEvents() {
    ...
    (_a5 = this._destroyRef) == null ? void 0 : _a5.onDestroy(() => {
...
var _ApplicationInitStatus = class _ApplicationInitStatus {
  constructor() {
    ...
    __publicField(this, "appInits", inject(APP_INITIALIZER, {
      optional: true
    }) ?? []);
...
var _ApplicationRef = class _ApplicationRef {
  constructor() {
    ...
    __publicField(this, "tickImpl", () => {
      ...
      try {
        ...
        (_a5 = this.tracingSnapshot) == null ? void 0 : _a5.dispose();
  ...
  synchronizeOnce() {
    ...
    if (this.dirtyFlags & 7) {
      ...
      (_b = (_a5 = this._rendererFactory) == null ? void 0 : _a5.begin) == null ? void 0 : _b.call(_a5);
...
async function triggerHydrationForBlockQueue(injector, hydrationQueue, replayQueuedEventsFn) {
  ...
  await ((_a5 = blocksBeingHydrated.get(lastBlockName)) == null ? void 0 : _a5.promise);
...
function cleanupRemainingHydrationQueue(hydrationQueue, dehydratedBlockRegistry) {
  ...
  for (const dehydratedBlockId in hydrationQueue) {
    (_a5 = blocksBeingHydrated.get(dehydratedBlockId)) == null ? void 0 : _a5.reject();
  }
...
function ɵɵdefer(index, primaryTmplIndex, dependencyResolverFn, loadingTmplIndex, placeholderTmplIndex, errorTmplIndex, loadingConfigIndex, placeholderConfigIndex, enableTimerScheduling, flags) {
  ...
  if (((_a5 = lContainer[DEHYDRATED_VIEWS]) == null ? void 0 : _a5.length) > 0) {
...
var LiveCollectionLContainerImpl = class extends LiveCollection {
  ...
  create(index, value) {
    ...
    (_a5 = this.operationsCounter) == null ? void 0 : _a5.recordCreate();
    return embeddedLView;
  }
  destroy(lView) {
    var _a5;
    destroyLView(lView[TVIEW], lView);
    (_a5 = this.operationsCounter) == null ? void 0 : _a5.recordDestroy();
  }
  updateValue(index, value) {
  ...
  reset() {
    ...
    (_a5 = this.operationsCounter) == null ? void 0 : _a5.reset();
  }
  updateIndexes() {
...
function ɵɵrepeater(collection) {
  ...
  try {
    ...
    if (ngDevMode && metadata.trackByFn === ɵɵrepeaterTrackByIdentity && ((_a5 = liveCollection.operationsCounter) == null ? void 0 : _a5.wasReCreated(liveCollection.length)) && isViewExpensiveToRecreate(getExistingLViewFromLContainer(lContainer, 0))) {
...
function listenerInternal(tView, lView, renderer, tNode, eventName, listenerFn, eventTargetResolver) {
  ...
  if (processOutputs) {
    const outputConfig = (_a5 = tNode.outputs) == null ? void 0 : _a5[eventName];
    const hostDirectiveOutputConfig = (_b = tNode.hostDirectiveOutputs) == null ? void 0 : _b[eventName];
...
function clearRendererCache(factory, def) {
  var _a5;
  (_a5 = factory.componentReplaced) == null ? void 0 : _a5.call(factory, def.id);
}
...
function executeWithInvalidateFallback(importMeta, id, callback) {
  ...
  try {
    ...
    if (id !== null && error.message) {
      ...
      (_b = (_a5 = importMeta == null ? void 0 : importMeta.hot) == null ? void 0 : _a5.send) == null ? void 0 : _b.call(_a5, "angular:invalidate", {
        id,
        message: toLog,
        error: true
      });
...
function directiveMetadata(type, metadata) {
  ...
  return {
    ...
    hostDirectives: ((_a5 = metadata.hostDirectives) == null ? void 0 : _a5.map((directive) => typeof directive === "function" ? {
      directive
    } : directive)) || null
  };
}
...
var _NgZoneChangeDetectionScheduler = class _NgZoneChangeDetectionScheduler {
  ...
  ngOnDestroy() {
    var _a5;
    (_a5 = this._onMicrotaskEmptySubscription) == null ? void 0 : _a5.unsubscribe();
  }
};
...
var _ChangeDetectionSchedulerImpl = class _ChangeDetectionSchedulerImpl {
  constructor() {
    ...
    __publicField(this, "disableScheduling", inject(ZONELESS_SCHEDULER_DISABLED, {
      optional: true
    }) ?? false);
    ...
    __publicField(this, "angularZoneId", this.zoneIsDefined ? (_a3 = this.ngZone._inner) == null ? void 0 : _a3.get(angularZoneInstanceIdProperty) : null);
    __publicField(this, "scheduleInRootZone", !this.zonelessEnabled && this.zoneIsDefined && (inject(SCHEDULE_IN_ROOT_ZONE, {
      optional: true
    }) ?? false));
  ...
  notify(source) {
    ...
    this.appRef.tracingSnapshot = ((_a5 = this.tracing) == null ? void 0 : _a5.snapshot(this.appRef.tracingSnapshot)) ?? null;
  ...
  cleanup() {
    ...
    (_a5 = this.cancelScheduledCallback) == null ? void 0 : _a5.call(this);
...
var _ImagePerformanceWarning = class _ImagePerformanceWarning {
  ...
  start() {
    var _a5, _b;
    if (typeof ngServerMode !== "undefined" && ngServerMode || typeof PerformanceObserver === "undefined" || ((_a5 = this.options) == null ? void 0 : _a5.disableImageSizeWarning) && ((_b = this.options) == null ? void 0 : _b.disableImageLazyLoadWarning)) {
      return;
    }
    ...
    if (win) {
      ...
      const setup = () => {
        ...
        if (doc.readyState === "complete") {
          ...
          (_a6 = this.window) == null ? void 0 : _a6.addEventListener("load", waitToScan, {
            once: true
          });
        }
      };
  ...
  ngOnDestroy() {
    var _a5;
    (_a5 = this.observer) == null ? void 0 : _a5.disconnect();
  }
  initPerformanceObserver() {
    ...
    const observer = new PerformanceObserver((entryList) => {
      ...
      const imgSrc = ((_a5 = lcpElement.element) == null ? void 0 : _a5.src) ?? "";
  ...
  scanImages() {
    ...
    images.forEach((image) => {
      var _a6, _b;
      if (!((_a6 = this.options) == null ? void 0 : _a6.disableImageSizeWarning)) {
    ...
    if (lcpElementFound && !lcpElementLoadedCorrectly && this.lcpImageUrl && !((_a5 = this.options) == null ? void 0 : _a5.disableImageLazyLoadWarning)) {
...
var _PlatformRef = class _PlatformRef {
  ...
  bootstrapModuleFactory(moduleFactory, options) {
    const scheduleInRootZone = options == null ? void 0 : options.scheduleInRootZone;
    const ngZoneFactory = () => getNgZone(options == null ? void 0 : options.ngZone, {
      ...getNgZoneOptions({
...
function createPlatformFactory(parentPlatformFactory, name, providers = []) {
  ...
  return (extraProviders = []) => {
    ...
    if (!platform) {
      ...
      platform = (parentPlatformFactory == null ? void 0 : parentPlatformFactory(platformProviders)) ?? createPlatform(createPlatformInjector(platformProviders, desc));
    }
...
function destroyPlatform() {
  var _a5;
  (_a5 = getPlatform()) == null ? void 0 : _a5.destroy();
}
...
function internalCreateApplication(config) {
  ...
  try {
    const platformInjector = (platformRef == null ? void 0 : platformRef.injector) ?? createOrReusePlatformInjector(platformProviders);
  ...
  const providers = [{
    ...
    useFactory: () => {
      ...
      if (typeof ngServerMode === "undefined" || !ngServerMode) {
        ...
        isEnabled = !!((_a5 = window._ejsas) == null ? void 0 : _a5[appId]);
      }
      if (isEnabled) {
      ...
      useFactory: () => {
        ...
        return () => {
          ...
          appRef.whenStable().then(() => {
            ...
            const jsActionMap = injector.get(JSACTION_BLOCK_ELEMENT_MAP);
            (_a5 = jsActionMap.get(EAGER_CONTENT_LISTENERS_KEY)) == null ? void 0 : _a5.forEach(removeListeners);
...
function appendSerializedNodePath(ngh, tNode, lView, excludedParentNodes) {
  ...
  const noOffsetIndex = tNode.index - HEADER_OFFSET;
  ngh[NODES] ?? (ngh[NODES] = {});
  (_a5 = ngh[NODES])[noOffsetIndex] ?? (_a5[noOffsetIndex] = calcPathForNode(tNode, lView, excludedParentNodes));
}
...
function componentUsesShadowDomEncapsulation(lView) {
  var _a5;
  const instance = lView[CONTEXT];
  return (instance == null ? void 0 : instance.constructor) ? ((_a5 = getComponentDef(instance.constructor)) == null ? void 0 : _a5.encapsulation) === ViewEncapsulation.ShadowDom : false;
}
...
function microtaskEffect(effectFn, options) {
  ...
  const injector = (options == null ? void 0 : options.injector) ?? inject(Injector);
  const destroyRef = (options == null ? void 0 : options.manualCleanup) !== true ? injector.get(DestroyRef) : null;
  const handle = new EffectHandle(injector.get(MicrotaskEffectScheduler), effectFn, typeof Zone === "undefined" ? null : Zone.current, destroyRef, injector, (options == null ? void 0 : options.allowSignalWrites) ?? false);
  ...
  if (!cdr || !(cdr._lView[FLAGS] & 8)) {
    ...
    ((_a5 = cdr._lView)[EFFECTS_TO_SCHEDULE] ?? (_a5[EFFECTS_TO_SCHEDULE] = [])).push(handle.watcher.notify);
  }
  return handle;
}
var _a4;
...
var BASE_EFFECT_NODE = (() => ({
  ...
  run() {
    ...
    this.hasRun = true;
    const registerCleanupFn = (cleanupFn) => (this.cleanupFns ?? (this.cleanupFns = [])).push(cleanupFn);
  ...
  maybeCleanup() {
    var _a5;
    if (!((_a5 = this.cleanupFns) == null ? void 0 : _a5.length)) {
      return;
    }
    try {
...
var VIEW_EFFECT_NODE = (() => ({
  ...
  destroy() {
    ...
    this.onDestroyFn();
    this.maybeCleanup();
    (_a5 = this.view[EFFECTS]) == null ? void 0 : _a5.delete(this);
  }
}))();
...
var ResourceImpl = class extends BaseWritableResource {
  constructor(request, loaderFn, defaultValue, equal, injector) {
    super(
      ...
      computed(() => {
        var _a5, _b;
        const streamValue = (_b = (_a5 = this.state()).stream) == null ? void 0 : _b.call(_a5);
    ...
    __publicField(this, "error", computed(() => {
      var _a5, _b;
      const stream = (_b = (_a5 = this.state()).stream) == null ? void 0 : _b.call(_a5);
  ...
  abortInProgressLoad() {
    ...
    untracked2(() => {
      var _a6;
      return (_a6 = this.pendingController) == null ? void 0 : _a6.abort();
    });
    this.pendingController = void 0;
    (_a5 = this.resolvePendingTask) == null ? void 0 : _a5.call(this);
    ...
    if (lView !== null) {
      for (let i = HEADER_OFFSET; i < lView.length; i++) {
        ...
        if (isComponentHost(tNode)) {
          ...
          const name = ((_a5 = def.debugInfo) == null ? void 0 : _a5.className) || def.type.name;
          if (name) {
            return name;
          } else {
            break;
...
var AFTER_RENDER_PHASE_EFFECT_NODE = (() => ({
  ...
  phaseFn(previousValue) {
    ...
    try {
      ...
      (_a5 = this.cleanup) == null ? void 0 : _a5.clear();
    }
    const args = [];
...
var AfterRenderEffectSequence = class extends AfterRenderSequence {
  ...
  destroy() {
    ...
    for (const node of this.nodes) {
      for (const fn of (node == null ? void 0 : node.cleanup) ?? EMPTY_CLEANUP_SET) {
        fn();
      }
    }
  }
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-NROOURDQ.js.map
