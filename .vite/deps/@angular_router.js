...
import {
  ...
  ViewportScroller
} from "./chunk-EQMDRLR6.js";
import "./chunk-DM7UL4HU.js";
import {
  DOCUMENT
} from "./chunk-MVVODDET.js";
import {
...
} from "./chunk-NROOURDQ.js";
import {
  defer,
  isObservable
} from "./chunk-3NZYUDRC.js";
...
var OutletContext = class {
  ...
  get injector() {
    var _a2;
    return getClosestRouteInjector((_a2 = this.route) == null ? void 0 : _a2.snapshot) ?? this.rootInjector;
  }
};
...
var ActivatedRoute = class {
  ...
  constructor(urlSubject, paramsSubject, queryParamsSubject, fragmentSubject, dataSubject, outlet, component, futureSnapshot) {
    ...
    this.title = ((_a2 = this.dataSubject) == null ? void 0 : _a2.pipe(map((d) => d[RouteTitleKey]))) ?? of(void 0);
    this.url = urlSubject;
...
var _NavigationTransitions = class _NavigationTransitions {
  ...
  handleNavigationRequest(request) {
    ...
    (_a2 = this.transitions) == null ? void 0 : _a2.next({
      ...request,
  ...
  isUpdatedBrowserUrl() {
    ...
    const targetBrowserUrl = ((_a2 = this.currentNavigation) == null ? void 0 : _a2.targetBrowserUrl) ?? ((_b = this.currentNavigation) == null ? void 0 : _b.extractedUrl);
...
var _HistoryStateManager = class _HistoryStateManager extends StateManager {
  ...
  get browserPageId() {
    ...
    return ((_a2 = this.restoredState()) == null ? void 0 : _a2.ɵrouterPageId) ?? this.currentPageId;
  }
...
var _Router = class _Router {
  constructor() {
    ...
    __publicField(this, "config", ((_a = inject(ROUTES, {
      optional: true
    })) == null ? void 0 : _a.flat()) ?? []);
    /**
